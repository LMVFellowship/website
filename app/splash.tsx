 ...
 *
 * Deliberately CSS-only. If a JavaScript overlay failed to unmount (a
 * hydration error, a blocked bundle, JS disabled) it would leave a black
 * sheet over the whole site with no way past it. A CSS animation with
